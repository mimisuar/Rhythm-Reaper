function love.load()
	...
	local t_dots = {{9,"jump"},{11,"jump"},{14,"jump"},{16,"attack"},{17,"jump"},{19,"jump"},{22,"attack"},{24,"attack"},{25,"jump"},{27,"jump"},{30,"jump"},{32,"jump"},{33,"attack"},{35,"attack"},{38,"attack"},{40,"attack"},{41,"jump"},{43,"jump"},{46,"jump"},{48,"attack"},{49,"jump"},{51,"jump"},{54,"jump"},{56,"attack"},{57,"jump"},{58,"attack"}}
	dots = {}
	for i=1, #t_dots do
		
		--table.insert(dots, t_dots[i][1] )--* c.quarter)
		table.insert(dots, ((t_dots[i][1] - 1) / 2) * c.quarter)
	end
...
function love.update(dt)
	...
	if dot_current <= #dots and dots[dot_current] - c.position < -epsilon[3] then
